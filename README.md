...
```shell
npx openapi-generator generate -i swagger.yaml -g python-flask -DpackageName=prov_service -o prov-service/
```
...
```shell
prov_service --mock_db --db_size 30
```
...
npx openapi-generator generate \
    ...
    -Dapis \
    -DapiTests=false \
    -i prov_service/openapi/openapi.yaml \
    -g python-flask \
    -o .
```
