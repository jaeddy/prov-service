...
from prov_service.models.agent import Agent  # noqa: E501
...
class ActivityForm(Model):
    ...
    @used.setter
    def used(self, used: List[Reference]):
    ...
    @property
    def generated(self) -> List[Reference]:
    ...
    @generated.setter
    def generated(self, generated: List[Reference]):
